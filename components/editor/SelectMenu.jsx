      ...
      {({ open }) => (
        <>
          <div className="relative mt-1 text-gray-900">
            <Listbox.Button className="relative w-[140px] cursor-default rounded-md border border-gray-300 bg-white py-1.5 pl-2.5 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
